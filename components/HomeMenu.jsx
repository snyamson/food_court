                        ...
                        <div className="col-md-4 text-center">
                          <div className="menu-wrap">
                            <a
                              ...
                              style={{
                                backgroundImage:
                                  'url("/assets/images/dessert-1.jpg")',
                              }}
                            ></a>
                            <div className="text">
                              <h3>
                        ...
                        <div className="col-md-4 text-center">
                          <div className="menu-wrap">
                            <a
                              ...
                              style={{
                                backgroundImage:
                                  'url("/assets/images/dessert-2.jpg")',
                              }}
                            ></a>
                            <div className="text">
                              <h3>
                        ...
                        <div className="col-md-4 text-center">
                          <div className="menu-wrap">
                            <a
                              ...
                              style={{
                                backgroundImage:
                                  'url("/assets/images/dessert-3.jpg")',
                              }}
                            ></a>
                            <div className="text">
                              <h3>
